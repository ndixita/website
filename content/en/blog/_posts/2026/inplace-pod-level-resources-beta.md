...
In this scenario, a Pod is defined with a 2 CPU aggregate limit. Because the individual containers do not have their own limits defined, they share this total pool.
...
spec:
  resources: # Pod-level aggregate limits
    limits:
      cpu: "2"
      memory: "4Gi"
  containers:
...
We encourage you to test this feature and provide feedback via the [Kubernetes Slack](https://kubernetes.slack.com) in the **\#sig-node** channel.
